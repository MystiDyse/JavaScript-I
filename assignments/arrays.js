...
console.log(
  `Last car in inventory is a ${lastCar.car_make} ${lastCar.car_model}`
);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [
  'Town Car','Sebring','Magnum','Jetta','Ciera','TT', 'Q7', 'R-Class', 'Yukon','Mustang','Evora', 'Econoline E250', 'Camry','LSS', 'XC70', '300M', "Escort",
"Wrangler","Ram Van 3500", "GTO", "6 Series","Topaz", "Aerio","Q", "Escalade","525" ,"MR2" ,"Talon" , "Wrangler" ,"Express 1500" ,"Familia" ,"Bravada","Prizm","Skylark",
"Montero Sport","Intrepid","Ram Van 1500", "Cavalier","Esprit","G35","E-Class", "Windstar", "4000CS Quattro", "Fortwo", "Accord", "Galant", "Accord", "Defender Ice Edition",
"Miata MX-5", "Navigator"]
...
let carYears = [
  inventory[0].car_year,
  inventory[1].car_year,
  inventory[2].car_year,
  inventory[3].car_year,
  inventory[4].car_year,
  inventory[5].car_year,
  inventory[6].car_year,
  inventory[7].car_year,
  inventory[8].car_year,
  inventory[9].car_year,
  inventory[10].car_year,
  inventory[11].car_year,
  inventory[12].car_year,
  inventory[13].car_year,
  inventory[14].car_year,
  inventory[15].car_year,
  inventory[16].car_year,
  inventory[17].car_year,
  inventory[18].car_year,
  inventory[19].car_year,
  inventory[20].car_year,
  inventory[21].car_year,
  inventory[22].car_year,
  inventory[23].car_year,
  inventory[24].car_year,
  inventory[25].car_year,
  inventory[26].car_year,
  inventory[27].car_year,
  inventory[28].car_year,
  inventory[29].car_year,
  inventory[30].car_year,
  inventory[31].car_year,
  inventory[32].car_year,
  inventory[33].car_year,
  inventory[34].car_year,
  inventory[35].car_year,
  inventory[36].car_year,
  inventory[37].car_year,
  inventory[38].car_year,
  inventory[39].car_year,
  inventory[40].car_year,
  inventory[41].car_year,
  inventory[42].car_year,
  inventory[43].car_year,
  inventory[44].car_year,
  inventory[45].car_year,
  inventory[46].car_year,
  inventory[47].car_year,
  inventory[48].car_year,
  inventory[49].car_year,
];
console.log(carYears.sort());

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
// let oldCars = [true carYears <= 2000];
// console.log(oldCars);
